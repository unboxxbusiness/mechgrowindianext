      ...
      <div className="md:grid md:grid-cols-2 md:gap-10 lg:gap-16 md:items-center">
        <div className="hidden md:block mb-24 md:mb-0 sm:px-6">
          <div className="relative">
            ...
            <div className="absolute bottom-0 left-0 -z-[1] translate-y-10 -translate-x-14">
              <svg className="max-w-[10rem] h-auto text-slate-400" width="696" height="653" viewBox="0 0 696 653" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div>
          ...
          <blockquote className="relative">
            <svg className="absolute top-0 left-0 transform -translate-x-8 -translate-y-4 h-24 w-24 text-gray-200" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            ...
            <footer className="mt-6">
              <div className="flex items-center">
                <div className="md:hidden flex-shrink-0">
                  <Image className="h-12 w-12 rounded-full" src="/Mantosh.png" alt="Image Description" width={1920} height={1280}/>
                </div>
                <div className="ml-4 md:ml-0">
                  <div className="text-base font-semibold text-gray-800 ">Mantosh Kumar</div>
                  <div className="text-xs text-gray-900 ">Co-Founder | Mechgrow <span className='text-green-600'>India</span></div>
                </div>
              </div>
            </footer>
    
            <div className="mt-8 lg:mt-14">
              <Link className="py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-semibold bg-green-600 text-white hover:bg-amber-500 focus:outline-none focus:ring-2 focus:ring-gray-800 focus:ring-offset-2 transition-all text-sm lg:p-4" href="https://wa.link/rdh2sc">
                Contact Sales Now
              </Link>
            </div>
          </blockquote>
