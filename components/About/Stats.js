  ...
  <div className="grid items-center lg:grid-cols-12 gap-6 lg:gap-12">
    <div className="lg:col-span-4">
      ...
      <div className="lg:pr-6 xl:pr-12">
        <p className="text-6xl font-bold leading-10 text-blue-800">
          92%
        ...
        <p className="mt-2 sm:mt-3 text-gray-900">ESD products are globally trusted safeguards, preventing electrostatic discharge and preserving sensitive electronics</p>
      </div>
    ...
    <div className="lg:col-span-8 relative lg:before:absolute lg:before:top-0 lg:before:-left-12 lg:before:w-px lg:before:h-full lg:before:bg-gray-200">
      <div className="grid gap-6 grid-cols-2 md:grid-cols-4 lg:grid-cols-3 sm:gap-8">
        ...
        <div>
          <p className="text-3xl font-semibold text-blue-800">99.95%</p>
        ...
        <div>
          <p className="text-3xl font-semibold text-blue-800">50+</p>
          <p className="mt-1 text-gray-900">partner with Mechgrow <span className='text-green-600 font-bold'>India</span></p>
        </div>
       

       
        <div>
          <p className="text-3xl font-semibold text-blue-800">85%</p>
