...
<div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
  ...
  <div className="md:grid md:grid-cols-2 md:items-center md:gap-12 xl:gap-32">
    <div>
      <Image className="rounded-xl" src="/home.png" alt="Image Description" width={1920} height={1280}/>
    </div>
    ...
    <div className="mt-5 sm:mt-10 lg:mt-0">
      <div className="space-y-6 sm:space-y-8">
        ...
        <div className="space-y-2 md:space-y-4">
          ...
          Your Next Big Step Starts Here-Contact MechGrow <span className="text-green-600">India </span>for Unmatched Expertise
          </h2>
          <p className="text-gray-900">
          Whether you are seeking advanced equipment or top-tier ESD solutions, our dedicated team is here to guide you every step of the way.
          </p>
        </div>
        ...
        <ul role="list" className="space-y-2 sm:space-y-4">
          <li className="flex space-x-3">
            ...
            <span className="text-sm sm:text-base text-gray-900">
              <span className="font-bold">Email</span> Sales@mechgrowindia.in
            </span>
          </li>
          ...
          <li className="flex space-x-3">
            ...
            <span className="text-sm sm:text-base text-gray-900">
              Helpine No <span className="font-bold">+91 9310595242 , +91 8404882358, +91 7250363666</span>
            </span>
          </li>
